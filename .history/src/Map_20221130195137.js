...
{
let lati=this.state.neighborhoods.latitude
let long = this.state.neighborhoods.longitude
let name= this.state.neighborhoods.neighborhood_group
alert(name)
		var myCircle = new MapboxCircle({lat: lati, lng:long }, this.state.data[name] , {
			editable: false,
			minRadius: 150,
			fillColor: '#29AB87'
		}).addTo(map);
