...
function App() {
  ...
  const popUp = () => {
    return (    
        <Card class = "container" css={{ mw: "400px", zIndex:1, width:'20vw', height:'100vh', borderRadius:"10", backgroundColor:"rgba(0, 0, 0, 0.5)", color:"white"}} >
       <Button size="lg" css={{ backgroundColor: "#3fb1ce", width:"10vw", alignSelf:'center'}} >↻ Refresh</Button>
         <Spacer y={1} />
