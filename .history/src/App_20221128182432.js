...
function App() {
  ...
  const popUp = () => {
    return (    
        <Card class = "container" css={{ mw: "400px", zIndex:1, width:'20=vw', height:'100vh', borderRadius:"0", backgroundColor:"rgba(0, 0, 0, 0.5)", color:"white"}} >
       <Button size="lg" css={{ backgroundColor: "#3fb1ce", width:"1vw", alignSelf:'center'}} >↻ </Button>
         <Spacer y={1} />
            
            <Spacer y = {2} />
            <Row>
            <Col span={4}><p class="inline" css={{ FontFace:"100px"}}>Hosts</p></Col>
            ...
            <Spacer y = {0.5} />
            <Dropdown>
                <Dropdown.Button css={{ backgroundColor: "#3fb1ce"}}>Select A Price Range</Dropdown.Button>
                <Dropdown.Menu>
            ...
            <Spacer y = {0.5} />
            <Dropdown>
                <Dropdown.Button css={{ backgroundColor: "#3fb1ce"}}>Select A Room Type</Dropdown.Button>
                <Dropdown.Menu>
            ...
            <Spacer y = {0.5} />
            <Dropdown>
                <Dropdown.Button css={{ backgroundColor: "#3fb1ce"}}>Select Minimum No. of Night</Dropdown.Button>
                <Dropdown.Menu>
