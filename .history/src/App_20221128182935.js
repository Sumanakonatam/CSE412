...
function App() {
  ...
  const popUp = () => {
    return (    
        <Card class = "container" css={{ mw: "400px", zIndex:1, width:'20vw', height:'50vh', marginTop:"15vh", marginLeft:"1vh" , borderRadius:"10", backgroundColor:"rgba(0, 0, 0, 0.5)", color:"white"}} >
