...
function App() {
  ...
  const popUp = () => {
    return (    
        <Card class = "container" css={{ mw: "400px", zIndex:1, width:'20vw', height:'50vh', marginTop:"20vh", marginLeft:"3vh" , borderRadius:"10", backgroundColor:"rgba(255, 255, 255, 255)", color:"white"}} >
       <Button size="lg" css={{ backgroundColor: "#3fb1ce", width:"1vw", alignSelf:'center'}} >↻ </Button>
         <Spacer y={1} />
            ...
            <Spacer y = {0.5} />
            <Dropdown>
                <Dropdown.Button css={{ backgroundColor: "#3fb1ce", width:'15vw', alignSelf:'center'}}>Select A Price Range</Dropdown.Button>
                <Dropdown.Menu>
            ...
            <Spacer y = {0.5} />
            <Dropdown>
                <Dropdown.Button css={{ backgroundColor: "#3fb1ce", width:'15vw', alignSelf:'center'}}>Select A Room Type</Dropdown.Button>
                <Dropdown.Menu>
            ...
            <Spacer y = {0.5} />
            <Dropdown>
                <Dropdown.Button css={{ backgroundColor: "#3fb1ce", width:'15vw', alignSelf:'center'}}>Select Minimum No. of Night</Dropdown.Button>
                <Dropdown.Menu>
