...
function App() {
  ...
  const popUp = () => {
    return (    
        <Card class = "container" css={{ mw: "400px", zIndex:1, width:'20vw', height:'100vh', backgroundColor:"rgba(0, 0, 0, 0.5)", color:"white"}} >
       <Button size="lg" css={{ backgroundColor: "#3fb1ce"}} >↻ Refresh</Button>
         <Spacer y={1} />
            
            <Spacer y = {2} />
            <Row>
            <Col span={4}><p class="inline">Hosts</p></Col>
                <Col span={4}><Switch checked = {true} color="#3fb1ce" /></Col>
